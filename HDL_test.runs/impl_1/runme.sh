...
HD_PWD='D:/Class Materials/Prime_Checker/HDL_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log prime_checker.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source prime_checker.tcl -notrace
